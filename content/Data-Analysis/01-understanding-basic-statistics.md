...
- **Constraint**: You don't need to reanalyse the data — just spot strong signals
...
- Comparison not ideal but not clearly manipulative
...
**strong signal identified**: Clear manipulation detected — classify as weak, move on.
